...
//            using var outErr = new MemoryStream();
...
//            using var errRdr = new StreamReader(outErr);
...
//                    var stream = result.Target switch
//                    {
//                        TargetStream.StandardIn => stdin,
//                        TargetStream.StandardOut => stdout,
//                        TargetStream.StandardError => stderr,
//                        _ => throw new InvalidOperationException($"Unknown TargetStream: '{result.Target}'."),
//                    };
