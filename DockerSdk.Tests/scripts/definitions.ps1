...
# It's intentional that "empty" and "remote" are not built here--they're used for building images that live on Dockerhub.
# The empty.image file is used with the local registries.
$imageDefinitions = @(
    @{
        name = 'parent'
    },
